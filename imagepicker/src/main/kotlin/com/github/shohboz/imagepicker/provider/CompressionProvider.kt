package com.github.shohboz.imagepicker.provider
...
import com.github.shohboz.imagepicker.ImagePickerActivity
import com.github.shohboz.imagepicker.util.ExifDataCopier
import com.github.shohboz.imagepicker.util.FileUtil
import com.github.shohboz.imagepicker.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.github.shohboz.imagepicker.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
